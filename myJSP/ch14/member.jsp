...
<script type="text/javascript">
  function idCheck(id) {
    ...
    window.open(url, "ID 중복체크", "width=340, height=180, top=100, left=100");
  }
    ...
    <div class="col-lg-7 col-md-9">
      <div class="card shadow-sm">
        <div class="card-header bg-warning text-dark py-3">
          <h5 class="mb-0 fw-bold">회원 가입</h5>
        </div>
        <div class="card-body p-4">
          <form name="regFrm" method="post" action="memberProc.jsp">
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9">
                <input type="password" name="pwd" class="form-control" value="1234">
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9">
                <input type="password" name="repwd" class="form-control" value="1234">
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9">
                <input type="text" name="name" class="form-control" value="가나다">
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9 pt-2">
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="gender" value="1" id="genderM" checked>
                  <label class="form-check-label" for="genderM">남</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" name="gender" value="2" id="genderF">
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9">
                <input type="text" name="birthday" class="form-control" value="891111" placeholder="예: 830815">
                <div class="form-text">생년월일을 적어 주세요. (예: 830815)</div>
              </div>
            </div>
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9">
                <input type="email" name="email" class="form-control" value="aaa@aaa.com">
            ...
            <div class="mb-3 row align-items-start">
              ...
              <div class="col-sm-9 pt-2">
                <div class="d-flex flex-wrap gap-3">
                  <%
                    String[] hobbies = {"인터넷","여행","게임","영화","운동"};
                    for (String h : hobbies) {
                  %>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="hobby" value="<%=h%>" id="hobby_<%=h%>">
                    <label class="form-check-label" for="hobby_<%=h%>"><%=h%></label>
                  </div>
                  <%}%>
                </div>
