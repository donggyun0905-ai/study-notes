				...
				<tr>
					<td bgcolor="#FFFFCC">
						<table border="1" cellspacing="0" cellpadding="2" width="600">
							...
							<tr>
								<td>비밀번호</td>
								<td><input type="password" name="pwd" size="15" value="1234"></td>
								<td>비밀번호를 적어주세요.</td>
							</tr>
							<tr>
								<td>비밀번호 확인</td>
								<td><input type="password" name="repwd" size="15" value="1234"></td>
								<td>비밀번호를 확인합니다.</td>
							</tr>
							<tr>
								<td>이름</td>
								<td><input name="name" size="15" value="가나다">
								</td>
								<td>이름을 적어주세요.</td>
							</tr>
							<tr>
							...
							<tr>
								<td>생년월일</td>
								<td><input name="birthday" size="6" value="891111">
									ex)830815</td>
								<td>생년월일를 적어 주세요.</td>
							</tr>
							<tr>
								<td>Email</td>
								<td><input name="email" size="30" value="aaa@aaa.com">
								</td>
								<td>이메일를 적어 주세요.</td>
							</tr>
							<tr>
