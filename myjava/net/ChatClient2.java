...
public class ChatClient2 extends JFrame implements ActionListener, Runnable {
	...
	public ChatClient2() {
		...
		//p1.add(tf1 = new JTextField("113.198.238.123", 10));
	...
	public void routine(String line) {
		...
		}else if(result[0].equals(ChatProtocol2.CHATALL) || result[0].equals(ChatProtocol2.CHATALL)){
			area.append(result[1] + "\n");
		}else if(result[0].equals(ChatProtocol2.MESSAGE)){
			//result[1]:bbb; 오늘은 여친 생일
			result = parseRoutine(result[1],ChatProtocol2.MODE2);
			new Message("FROM:",result[0]/*bbb*/,result[1]);
	...
	//채팅내용을 저장하고(파일명은 오늘날짜+시간) DialogBox 알림으로 표시
